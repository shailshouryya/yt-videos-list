...
class Common:
    ...
    def format_operadriver_list(cls, operating_system):
        return [
            ...
            cls.format_operadriver_download_comment(operating_system, 'v.77.0.3865.120', '64'),
            cls.format_operadriver_download_command(operating_system, 'v.77.0.3865.120'),
            cls.format_operadriver_download_comment(operating_system, 'v.76.0.3809.132', '63'),
            cls.format_operadriver_download_command(operating_system, 'v.76.0.3809.132'),
            cls.format_operadriver_download_comment(operating_system, 'v.75.0.3770.100', '62'),
