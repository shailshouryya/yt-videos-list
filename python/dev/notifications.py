...
class Common:
    ...
    def format_geckodriver_list(cls, operating_system):
        return [
            cls.format_driver_information          (operating_system, 'v0.30.0', '≥ 92', 'geckodriver', 'Mozilla Firefox'),
    ...
    def format_operadriver_list(cls, operating_system):
        return [
            cls.format_driver_information          (operating_system, 'v.93.0.4577.63',  'Stable 79', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(operating_system, 'v.93.0.4577.63'),
            cls.format_driver_information          (operating_system, 'v.92.0.4515.107', 'Stable 78', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(operating_system, 'v.92.0.4515.107'),
            cls.format_driver_information          (operating_system, 'v.91.0.4472.77',  'Stable 77', 'operadriver', 'Opera'),
    ...
    def format_chromedriver_list(cls, operating_system):
        return [
            cls.format_driver_information           (operating_system, '95.0.4638.10',  '95', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '95.0.4638.10'),
            cls.format_driver_information           (operating_system, '94.0.4606.41',  '94', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '94.0.4606.41'),
            cls.format_driver_information           (operating_system, '93.0.4577.63',  '93', 'chromedriver', 'Google Chrome'),
    ...
    def format_bravedriver_list(cls, operating_system):
        return [
            cls.format_driver_information          (operating_system, 'v.93.0.4577.63',  '93', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(operating_system, 'v.93.0.4577.63'),
            cls.format_driver_information          (operating_system, 'v.92.0.4515.107', '92', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(operating_system, 'v.92.0.4515.107'),
            cls.format_driver_information          (operating_system, 'v.91.0.4472.77',  '91', 'bravedriver (operadriver based)', 'Brave Browser'),
    ...
    def format_msedgedriver_list(cls, operating_system):
        return [
            cls.format_driver_information           (operating_system, '94.0.992.38',  '94', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(operating_system, '94.0.992.38'),
            cls.format_driver_information           (operating_system, '93.0.961.52',  '93', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(operating_system, '93.0.961.52'),
            cls.format_driver_information           (operating_system, '92.0.902.84',  '92', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(operating_system, '92.0.902.84'),
            cls.format_driver_information           (operating_system, '91.0.864.71',  '91', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(operating_system, '91.0.864.71'),
            cls.format_driver_information           (operating_system, '90.0.818.66',  '90', 'msedgedriver', 'Microsoft Edge'),
